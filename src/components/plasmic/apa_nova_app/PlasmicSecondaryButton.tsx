...
import sty from "./PlasmicSecondaryButton.module.css"; // plasmic-import: O5dT0tkpxdk/css
...
export type PlasmicSecondaryButton__VariantMembers = {
...
export type PlasmicSecondaryButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicSecondaryButton__VariantsArgs;
export const PlasmicSecondaryButton__VariantProps = new Array<VariantPropType>(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export type PlasmicSecondaryButton__ArgsType = {
...
type ArgPropType = keyof PlasmicSecondaryButton__ArgsType;
export const PlasmicSecondaryButton__ArgProps = new Array<ArgPropType>(
  "children",
  "startIcon",
  "endIcon",
  "link"
...
export type PlasmicSecondaryButton__OverridesType = {
  root?: p.Flex<"button">;
...
export interface DefaultSecondaryButtonProps extends pp.BaseButtonProps {
  shape?: SingleChoiceArg<"rounded" | "round" | "sharp">;
  size?: SingleChoiceArg<"compact" | "minimal">;
  color?: SingleChoiceArg<
    | "blue"
...
function PlasmicSecondaryButton__RenderFunc(props: {
  ...
  overrides: PlasmicSecondaryButton__OverridesType;
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootbtnType_primary]: hasVariant(variants, "btnType", "primary"),
          [sty.rootbtnType_secondary]: hasVariant(
            variants,
            "btnType",
            "secondary"
          ),
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xs7G)}
                role={"img"}
              />
            ),
        ...
        {p.renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            [sty.slotTargetChildren___focusVisibleWithin]:
              triggers.focusVisibleWithin_root,
            [sty.slotTargetChildrenbtnType_secondary]: hasVariant(
              variants,
              "btnType",
              "secondary"
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__xxzQm)}
                role={"img"}
              />
            ),
...
function useBehavior<P extends pp.BaseButtonProps>(
  ...
  const b = pp.useButton<P, typeof PlasmicSecondaryButton>(
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSecondaryButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicSecondaryButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicSecondaryButton__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSecondaryButton";
  } else {
    func.displayName = `PlasmicSecondaryButton.${nodeName}`;
  }
  return func;
}

export const PlasmicSecondaryButton = Object.assign(
  // Top-level PlasmicSecondaryButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSecondaryButton
    internalVariantProps: PlasmicSecondaryButton__VariantProps,
    internalArgProps: PlasmicSecondaryButton__ArgProps,

    useBehavior
  }
);

export default PlasmicSecondaryButton;
/* prettier-ignore-end */
