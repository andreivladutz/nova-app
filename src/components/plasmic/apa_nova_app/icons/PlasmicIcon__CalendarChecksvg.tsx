...
export type CalendarChecksvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function CalendarChecksvgIcon(props: CalendarChecksvgIconProps) {
...
export default CalendarChecksvgIcon;
/* prettier-ignore-end */
